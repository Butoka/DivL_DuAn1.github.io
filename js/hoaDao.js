    ...
    let img_url = 'https://haidangmedia.net/wp-content/plugins/devvn-tet-holiday/images/hoadao.png';
    var hidesnowtime = 0;
    var color_snow = '#fff';
    ...
    for (i = 0; i < no; ++i) {
      ...
      if (ie4up || ns6up) {
        document.write('<div id="dot' + i + '" style="POSITION:fixed;Z-INDEX:' + (9999 + i) + ';VISIBILITY:visible;TOP:15px;LEFT:15px;pointer-events: none;width:15px"><span style="font-size:18px;color:' + color_snow + '"><img src="' + img_url + '" alt=""></span></div>');
      }
    }
